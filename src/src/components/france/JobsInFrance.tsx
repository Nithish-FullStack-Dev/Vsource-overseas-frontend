...
type Column = {
  ...
  salary: number; // average salary in EUR/year
  jobs: string[];
};
...
const BASE_COLUMNS: Column[] = [
  ...
  },
  {
    ...
    icon: PaletteIcon,
    salary: 46000,
    jobs: ["Energy Analyst", "Solar PV Engineer", "Wind Turbine Tech", "Sustainability Consultant"],
  },
  {
    key: "aerospace",
    title: "Aerospace",
    ...
    icon: CameraIcon,
    salary: 54000,
    jobs: ["Aerospace Engineer", "Avionics Engineer", "Flight Test Engineer", "Airworthiness Engineer"],
  },
  {
    key: "business",
    title: "Business",
...
/* ---- utilities ---- */
const eur = (n: number) =>
  n.toLocaleString("en-US", { style: "currency", currency: "EUR", maximumFractionDigits: 0 }) + "/yr";
...
export default function JobsInFranceFlow() {
  ...
  return (
    <section className="py-12 md:py-16 bg-white">
      ...
      >
        ...
        <div className="mt-6">
          <div className="flex gap-2 overflow-x-auto no-scrollbar justify-center md:justify-center">
      ...
      <div className="w-full rounded-[8px] text-white shadow-sm relative" style={{ backgroundColor: col.color }}>
        ...
        <div className="px-5 pb-5 flex justify-center">
          <div className="bg-white text-black rounded-md px-3 py-1.5 text-center shadow-sm">
            ...
            <div className="text-sm md:text-base font-extrabold">{eur(col.salary)}</div>
          </div>
        </div>
...
/* FIX: augment React's CSSProperties instead of CSSStyleDeclaration */
