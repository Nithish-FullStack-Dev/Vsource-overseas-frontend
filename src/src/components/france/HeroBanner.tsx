...
type Props = {
  title?: string;
  subtitle?: string; // NEW: short, punchy strapline
  ctaText?: string;
  ctaHref?: string;
  bgImage?: string; // e.g. /assets/images/france.jpeg
...
export default function HeroBanner({
  ...
  subtitle = "Top-ranked universities • 500+ scholarships • 1,500 English-taught programs",
  ctaText = "Start your France Journey →",
  ctaHref = "/contact",
  bgImage = "/assets/images/france.jpg",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-6 text-center">
        ...
        {subtitle ? (
          <p className="mt-3 max-w-[780px] text-white/90 text-sm md:text-lg leading-snug">
            {subtitle}
          </p>
        ) : null}
