...
const firstRow: Highlight[] = [
  ...
  { label: "Population", value: "33.5 crores+" }, // ≈ 335 million+
  { label: "Currency", value: "USD ($)" },
  { label: "Quality of Life", value: "Very High" },
];

const secondRow: Highlight[] = [
  { label: "Major Cities", value: "New York, Los Angeles, Chicago, Houston, Phoenix" },
  { label: "No. of International Students", value: "10,00,000+" },
  { label: "Top Sectors", value: "Healthcare, IT, AI, Retail Trade" },
];
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-black">USA OVERVIEW</h2>
