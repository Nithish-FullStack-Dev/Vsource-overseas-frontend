...
const RedIcon: React.FC<{
  ...
  size?: number;
  aosDelay?: number;
}> = ({ src, alt = "icon", size = 56, aosDelay = 100 }) => (
  <span
    role="img"
    aria-label={alt}
    data-aos="fade-right"
...
const features: Feature[] = [
  {
    ...
    bgColor: GREY,
    title: "Collateral Free Loans Up to 85 lakhs*",
  },
  {
    icon: "/icons/money.png",
    bgColor: GREY,
    title: "Up to 100% financing with flexible repayment options*",
  },
  {
    icon: "/icons/check-mark.png",
    bgColor: GREY,
    title: "Quick & Easy Application Process",
  },
  {
    icon: "/icons/home-icon-silhouette.png",
    bgColor: GREY,
    title: "Income tax benefits under section 80E",
  },
];
    ...
    <div className="financial-assistance bg-white py-12">
      <div className="w-full max-w-[1400px] mx-auto px-4">
        ...
        <div
          ...
          data-aos-duration="700"
        >
          <a href="https://demofintech.vsource.online/" target="_blank">
            <button
          ...
          <a href="https://demofintech.vsource.online/contact" target="_blank">
            <button
