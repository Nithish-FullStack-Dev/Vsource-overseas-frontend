...
type Column = {
  ...
  salary: number; // average salary in USD/year
  jobs: string[];
};
...
/* ---- utilities ---- */
const usd = (n: number) =>
  n.toLocaleString("en-US", { style: "currency", currency: "USD", maximumFractionDigits: 0 }) + "/yr";
...
export default function JobsInUSAFlow() {
        ...
        <div className="mt-12 text-center">
          ...
          <div className="grid-layout hidden sm:flex justify-center gap-4 mt-8">
            {[
              ...
              "/assets/images/students/PEDDIENENI HEMA PRIYA (USA).jpeg",
            ].map((src, idx) => (
              <img
                key={idx}
                src={src}
      ...
      <div className="w-full rounded-[8px] text-white shadow-sm relative" style={{ backgroundColor: col.color }}>
        ...
        <div className="px-5 pb-5 flex justify-center">
          <div className="bg-white text-black rounded-md px-3 py-1.5 text-center shadow-sm">
            ...
            <div className="text-sm md:text-base font-extrabold">{usd(col.salary)}</div>
          </div>
        </div>
